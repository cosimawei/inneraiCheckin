...
async def main():
	"""主函数"""
	print('[SYSTEM] InnerAI multi-account auto check-in script started (using Playwright)')
	...
	if need_notify and notification_content:
		...
		notify.push_message('InnerAI Check-in Alert', notify_content, msg_type='text')
